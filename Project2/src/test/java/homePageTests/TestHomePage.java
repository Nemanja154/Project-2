...
public class TestHomePage extends BaseClass {
    ...
    public void formsButton(){
        scroll(homePageWebElements.getForms());
    ...
    public void alertsFrameWindowsButton(){
        scroll(homePageWebElements.getAlertsFarmWindows());
    ...
    public void widgetsButton(){
        scroll(homePageWebElements.getWidgets());
    ...
    public void interactionsButton(){
        scroll(homePageWebElements.getInteractions());
    ...
    public void bookStoreApplicationButton(){
        scroll(homePageWebElements.getBookStoreApplication());
